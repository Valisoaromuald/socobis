...
public class Vente extends FactureCF {
    ...
    public String toString() {
        return "Vente [designation=" + designation + ", idMagasin=" + idMagasin + ", remarque=" + remarque
                + ", idOrigine=" + idOrigine + ", idClient=" + idClient + ", clientlib=" + clientlib + ", compte="
                + compte + ", tauxdechange=" + tauxdechange + ", venteDetails=" + Arrays.toString(venteDetails)
                + ", estPrevu=" + estPrevu + ", montantRevient=" + montantRevient + ", margeBrute=" + margeBrute
                + ", echeancefacture=" + echeancefacture + ", modepaiement=" + modepaiement + ", fraislivraison="
                + fraislivraison + ", modelivraison=" + modelivraison + ", referencefact=" + referencefact
